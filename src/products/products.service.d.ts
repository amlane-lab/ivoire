...
export declare class ProductService {
    ...
    getDealProductByIds(productIds: any, page: number, limit: number): Promise<any>;
    ...
    getAllProductByCategoryForPos(categoryId: string, page: number, limit: number): Promise<Array<any>>;
