...
export declare class UserController {
    ...
    constructor(userService: UserService, authService: AuthService, utilService: UtilService, emailService: EmailService, uploadService: UploadService, otpService: OtpService, orderService: OrderService);
    ...
    registerNewAdmin(user: UsersDTO, userData: UserCreateDTO): Promise<CommonResponseModel>;
    deleteAdmin(user: UsersDTO, userId: string): Promise<CommonResponseModel>;
    updateAdminStatus(user: UsersDTO, userId: string, userStatusData: UserStatusDTO): Promise<CommonResponseModel>;
    getAllAdminList(user: UsersDTO, adminQuery: AdminQuery): Promise<CommonResponseModel>;
    deleteUser(user: UsersDTO, userId: string): Promise<CommonResponseModel>;
}
