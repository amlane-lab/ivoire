...
export declare class UserService {
    ...
    countUserByFilter(startDate: any, endDate: any): Promise<number>;
    userGraph(startDate: any, endDate: any, type: any): Promise<any>;
    deleteUserById(userId: String): Promise<UsersDTO>;
    getAllAdmin(page: number, limit: number, search: string): Promise<Array<AdminUserDTO>>;
    countAllAdmin(search: string): Promise<number>;
}
